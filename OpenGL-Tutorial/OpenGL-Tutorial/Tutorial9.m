...
// class Tutorial4
@interface Tutorial9 : NSObject <GSOpenGLViewDelegate>

@end

@implementation Tutorial9
...
- (BOOL)prepareRenderData
{
    ...
    program = [shaderController programWithVertexShaderFile:@"tutorial9.vs" FragmentShaderFile:@"tutorial9.fs"];
...
- (void)prepareOpenGL
{
    ...
    Set_OpenGLViewDelegate(Tutorial9);
}
